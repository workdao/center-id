...
$ITV_ADMIN_EMAILS = array('andrew@wagin.ru', 'a@45.lc', 'mail@center-id.ru');
...
add_action('wp_enqueue_scripts', function(){
   ...
   // wp_enqueue_style('gfonts', 'http://fonts.googleapis.com/css?family=Open+Sans|PT+Serif&subset=latin,cyrillic', array());
    ...
    wp_enqueue_style('front', $url.'/css/front.css', array(), '1.1');
...
echo '<link rel="shortcut icon" type="image/x-icon" href="http://center-id.ru/wp-content/themes/tstsite/img/logo-v.png" />
    <link href="http://center-id.ru/wp-content/themes/tstsite/img/logo-v.png" rel="icon" type="image/x-icon" />';
}
